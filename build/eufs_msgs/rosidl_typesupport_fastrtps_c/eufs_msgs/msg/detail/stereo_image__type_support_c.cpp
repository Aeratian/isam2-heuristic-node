...
#include "eufs_msgs/msg/detail/stereo_image__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/image__functions.h"  // color, depth
...
using _StereoImage__ros_msg_type = eufs_msgs__msg__StereoImage;
...
size_t get_serialized_size_eufs_msgs__msg__StereoImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _StereoImage__ros_msg_type * ros_message = static_cast<const _StereoImage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _StereoImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__StereoImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eufs_msgs
size_t max_serialized_size_eufs_msgs__msg__StereoImage(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_eufs_msgs__msg__StereoImage(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eufs_msgs, msg, StereoImage)() {
