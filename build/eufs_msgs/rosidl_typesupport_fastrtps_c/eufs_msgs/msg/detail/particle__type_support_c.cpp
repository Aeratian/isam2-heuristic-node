...
#include "eufs_msgs/msg/detail/particle__rosidl_typesupport_fastrtps_c.h"
...
#include "eufs_msgs/msg/detail/cone_array_with_covariance__functions.h"  // map
...
using _Particle__ros_msg_type = eufs_msgs__msg__Particle;
...
static uint32_t _Particle__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eufs_msgs__msg__Particle(
...
{
  return max_serialized_size_eufs_msgs__msg__Particle(
    full_bounded, 0);
}
